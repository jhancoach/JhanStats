...
export const PlayerProfileView: React.FC<PlayerProfileViewProps> = ({ players }) => {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 h-auto lg:h-[calc(100vh-140px)] animate-fade-in relative">
      ...
      {/* Main Profile Content (New Scout Design) */}
      <div id="printable-profile" className="flex-1 flex flex-col gap-6 overflow-y-auto custom-scrollbar pr-1 pb-10">
         ...
         <div className="bg-[#0B0F19] rounded-3xl p-6 md:p-8 border border-white/10 relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div className="w-full md:w-auto flex flex-col items-stretch md:items-end gap-3">
                    <button 
                        onClick={handlePrint}
                        className="px-6 py-3 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl text-sm font-bold uppercase tracking-wider transition-all shadow-lg shadow-indigo-600/20 flex items-center justify-center gap-2 group no-print"
                    >
